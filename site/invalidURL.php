...
<head>
    ...
    <title>Employee Recognition Awards - Password Recovery Expired</title>
    <!-- Bootstrap core CSS -->
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
		  ...
		  <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">Password Recovery Expired.</h1>
			
	        <p> Your passsword recovery link has expired.</p>
			<p> Redirecting to login screen in 5 seconds.</p>
		  </div>
    </div>
</div>
</body>
